...
public class ServerPanel extends Parent {
    ...
    public ServerPanel(Stage stage) {
        ...
        this.erreurPort = new Text("Numéro de port invalide, vérifiez votre saisie.");
        this.erreurPort.setLayoutX(150);
        this.erreurPort.setLayoutY(240);
        this.erreurPort.setFill(Color.RED);
        this.erreurPort.setVisible(false);
        ...
        this.getChildren().add(this.erreurPort);
